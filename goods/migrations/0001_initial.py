# Generated by Django 2.2.2 on 2019-07-14 13:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='goods.Color')),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='goods.Goods')),
                ('size', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='goods.Size')),
            ],
        ),
        migrations.CreateModel(
            name='GoodsDetail',
            fields=[
                ...
                ('gdname', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='goods.GoodsDetailName')),
                ('goods', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='goods.Goods')),
            ],
        ),
    ]
